...
1. **Chronology / provenance** — which object existed at which Git/archival revision and date.
2. **Derivation history** — how residual/error, parameter, class, boundary, projection and critical-space structures evolved.
3. **Mathematical validity** — proved, external theorem, conditional, open bridge, inconsistent specification.
4. **External archival support** — Git objects, Zenodo/DOI metadata, file hashes and reproducibility.
5. **Priority** — earliest verified occurrence in the audited corpus versus worldwide novelty.
6. **Causal access** — whether a later party accessed/derived from earlier work; chronology and similarity alone do not establish this.
...
## 3. Provenance / genealogy / external comparison
...
- `audit/17_deep_proof_origin_integral_sweep.md`
- `audit/18_indeterminacy_meta_provenance.md`
- `audit/18_master_error_framework_provenance.md`
- `audit/19_cross_problem_research_map.md`
- `audit/20_formal_corpus_commit_sweep.md`
- `audit/21_multiprover_declaration_DAG_protocol.md`
...
## 4. Mathematical boundary and peer-review layer

- `audit/25_theorem_status_matrix.md`
- `audit/26_bridge_obligations.md`
- `audit/30_peer_review_report.md`
- `audit/31_exact_origin_ns_error_to_L3_bridge.md`
- `audit/33_mathlib4_LInf_L3_formalization_map.md`
- `audit/35_peer_review_master_protocol.md`
- `audit/36_clay_submission_grade_problem_dossiers.md`
- `audit/37_unified_asymptotic_measurement_framework.md`
- `audit/38_parameter_equivalence_percentage_numeric_class_genealogy.md`
- `audit/39_sorry_indeterminate_parameter_completion.md`
...
- `data/declaration_nodes.csv`
- `data/declaration_edges.csv`
...
Audit-safe logic and certificate structures:
...
A typed hypothesis yields a conditional theorem; it does not count as closing the hypothesis.

## 8. High-level derivation graph

```text
2025 mathematical/archival precursors
        ↓
Navier–Stokes / RH / PNP / BSD-Hodge-YM repositories
        ↓
classical + multiprover formalization
        ↓
projection → residual → closure obstruction
        ↓
residual-dependent coupling / correction
        ↓
error / parameter / percentage / numeric-class architecture
        ↓
...
[OPEN unless individually discharged]
        ↓
recognized classical endpoint
```

The common architecture does not erase the final native mathematics of each problem.
